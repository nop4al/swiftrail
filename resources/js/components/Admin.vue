...
const refunds = ref([
  { id: 'REF001', orderId: 'ORD12345', amount: 500000, status: 'pending', date: '2024-12-01', reason: 'Dibatalkan penumpang', user: 'Adi Wibowo' },
  { id: 'REF002', orderId: 'ORD12346', amount: 750000, status: 'approved', date: '2024-11-28', reason: 'Kereta dibatalkan', user: 'Siti Nurhaliza' },
  { id: 'REF003', orderId: 'ORD12347', amount: 300000, status: 'processed', date: '2024-11-25', reason: 'Perubahan jadwal', user: 'Bambang Irawan' },
  { id: 'REF004', orderId: 'ORD12348', amount: 1000000, status: 'pending', date: '2024-12-02', reason: 'Tidak ada kursi tersedia', user: 'Rina Wijaya' },
  { id: 'REF005', orderId: 'ORD12349', amount: 450000, status: 'rejected', date: '2024-11-20', reason: 'Tidak sesuai kebijakan', user: 'Dedi Gunawan' }
])
...
const stations = ref([
  { id: 1, code: 'GMR', name: 'Stasiun Gambir', city: 'Jakarta', active: true },
  { id: 2, code: 'BD', name: 'Stasiun Bandung', city: 'Bandung', active: true },
  { id: 3, code: 'YIA', name: 'Stasiun Yogyakarta', city: 'Yogyakarta', active: true },
  { id: 4, code: 'SBY', name: 'Stasiun Surabaya', city: 'Surabaya', active: true }
])

const trainTypes = ref([
  { id: 1, code: 'KRL', name: 'KRL Commuter', capacity: 500, active: true },
  { id: 2, code: 'LRT', name: 'Light Rail Transit', capacity: 300, active: true },
  { id: 3, code: 'EXP', name: 'Eksekutif', capacity: 200, active: true },
  { id: 4, code: 'BISNIS', name: 'Bisnis', capacity: 250, active: true }
])

const routes = ref([
  { id: 1, code: 'R001', from: 'Jakarta', to: 'Bandung', duration: '3 jam', active: true },
  { id: 2, code: 'R002', from: 'Jakarta', to: 'Yogyakarta', duration: '10 jam', active: true },
  { id: 3, code: 'R003', from: 'Bandung', to: 'Surabaya', duration: '8 jam', active: true }
])
...
const trains = ref([
  { 
    id: 1, 
    code: 'KRL-001', 
    name: 'KRL Jarak Jauh Express 1',
    type: 'KRL', 
    capacity: 500,
    status: 'active',
    schedules: [
      { id: 1, route: 'R001', departureTime: '06:00', arrivalTime: '09:00', days: 'Setiap Hari' }
    ]
  },
  { 
    id: 2, 
    code: 'KRL-002', 
    name: 'KRL Jarak Jauh Express 2',
    type: 'KRL', 
    capacity: 500,
    status: 'active',
    schedules: [
      { id: 1, route: 'R001', departureTime: '07:30', arrivalTime: '10:30', days: 'Setiap Hari' },
      { id: 2, route: 'R001', departureTime: '16:00', arrivalTime: '19:00', days: 'Senin-Jumat' }
    ]
  },
  { 
    id: 3, 
    code: 'EXP-001', 
    name: 'Eksekutif Premium Jakarta-Yogya',
    type: 'EXP', 
    capacity: 200,
    status: 'active',
    schedules: [
      { id: 1, route: 'R002', departureTime: '08:00', arrivalTime: '18:00', days: 'Setiap Hari' }
    ]
  },
  { 
    id: 4, 
    code: 'BISNIS-001', 
    name: 'Bisnis Malam Jakarta-Yogya',
    type: 'BISNIS', 
    capacity: 250,
    status: 'active',
    schedules: [
      { id: 1, route: 'R002', departureTime: '14:00', arrivalTime: '00:00+1', days: 'Setiap Hari' }
    ]
  },
  { 
    id: 5, 
    code: 'LRT-001', 
    name: 'LRT Bandung-Surabaya',
    type: 'LRT', 
    capacity: 300,
    status: 'active',
    schedules: [
      { id: 1, route: 'R003', departureTime: '05:00', arrivalTime: '13:00', days: 'Setiap Hari' },
      { id: 2, route: 'R003', departureTime: '13:00', arrivalTime: '21:00', days: 'Setiap Hari' }
    ]
  }
])
